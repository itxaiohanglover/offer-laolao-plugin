    ...
    removeBtn.addEventListener("click", function () {
      ...
      if (parent && list) {
        ...
        if (isEmpty || itemCount > 1) {
          ...
          const notification =
            window.OfferLaolao?.Services?.NotificationService;
...
function createEducationItem(index) {
  ...
  div.innerHTML =
    ...
    index +
    '][school]" placeholder="请输入学校名称">' +
    "</div>" +
    '<div class="form-group">' +
    "<label>专业</label>" +
    '<input type="text" name="education[' +
    index +
    '][major]" placeholder="请输入专业">' +
    "</div>" +
    '<div class="form-group">' +
    "<label>学历</label>" +
...
function createWorkExperienceItem(index) {
  ...
  div.innerHTML =
    ...
    "<div>" +
    "<label>开始时间</label>" +
    '<input type="date" name="internship[' +
    index +
    '][start-date]">' +
    "</div>" +
    "<div>" +
    ...
    index +
    '][description]" placeholder="请输入实习/工作描述"></textarea>' +
    "</div>";
...
function createProjectItem(index) {
  ...
  div.innerHTML =
    ...
    '<input type="text" name="project[' +
    index +
    '][role]" placeholder="请输入担任角色">' +
    "</div>" +
    '<div class="form-group">' +
    "<label>项目时间</label>" +
    '<input type="text" name="project[' +
    index +
    '][project-time]" placeholder="请输入项目时间">' +
    "</div>" +
    '<div class="form-group">' +
    "<label>项目描述</label>" +
    '<textarea name="project[' +
    index +
    '][project-desc]" placeholder="请输入项目描述"></textarea>' +
    "</div>" +
    '<div class="form-group">' +
    "<label>职责描述</label>" +
    '<textarea name="project[' +
    index +
    '][responsibilities]" placeholder="请输入职责描述"></textarea>' +
    "</div>";
...
function createLanguageItem(index) {
  ...
  div.innerHTML =
    ...
    index +
    '][name]" placeholder="请输入语言名称（如：英语、日语）">' +
    "</div>" +
    '<div class="form-group">' +
    "<label>掌握程度</label>" +
    ...
    '<input type="text" name="language[' +
    index +
    '][certificate]" placeholder="请输入证书名称（如：大学英语六级）">' +
    "</div>";
...
function createCustomFieldItem(index) {
  ...
  div.innerHTML =
    ...
    index +
    '][name]" placeholder="请输入字段名称">' +
    "</div>" +
    '<div class="form-group">' +
    "<label>字段内容</label>" +
    '<textarea name="custom[' +
    index +
    '][content]" placeholder="请输入字段内容"></textarea>' +
    "</div>";
